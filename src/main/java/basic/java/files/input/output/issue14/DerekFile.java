...
public class DerekFile extends JFrame{
        ...
        public static void main(String[] args){
            ...
            randomFile = new File("./Derek/derek.txt");

            // Make a file and define where to save it in the file system

            randomFile2 = new File("./Derek/derek2.txt");
            ...
            if (randomFile.exists()){
                ...
                randomFile2.renameTo(new File("./derek3.txt"));
