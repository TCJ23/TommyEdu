...
public class DerekFilesRW {
    ...
    public static void main(String[] args) {
        ...
        File dir = new File("./Derek");
        dir.mkdir();

//        File file = new File("./Derek/customers.txt");

       /* PrintWriter custOutput = null;
        try {
            custOutput = new PrintWriter(file);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }*/
        PrintWriter custOutput = createFile("./Derek/customers.txt");
